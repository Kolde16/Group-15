...
This tool relies on `ifcopenshell` for BIM processing and `pandas` for data handling, only `ifcopenshell` needs an installation. Paste the following into the console and press enter:
