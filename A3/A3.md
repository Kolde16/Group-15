...
The attribute/property is mandatory for the script to execute successfully and provide a key output (e.g., area or a calculated U-value).

The attribute/property significantly increases the accuracy of the result (e.g., enabling the precise composite U-value calculation for windows) but the script provides a fallback if it is absent.
